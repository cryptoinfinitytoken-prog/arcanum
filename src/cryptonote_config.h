...
namespace config
{
  ...
  // ARCANUM PORTS (Unique lane)
  uint16_t const P2P_DEFAULT_PORT = 19990;
  uint16_t const RPC_DEFAULT_PORT = 19991;
  uint16_t const ZMQ_RPC_DEFAULT_PORT = 19992;
  
  // ARCANUM IDENTITY (Unique Handshake)
  boost::uuids::uuid const NETWORK_ID = { {
      0x12, 0x30, 0xF1, 0x71, 0x61, 0x04, 0x41, 0x61, 0x17, 0x31, 0x00, 0x82, 0x16, 0xA1, 0xA1, 0x88
    } };
  
  std::string const CRYPTONOTE_NAME = "arcanum";

  // STANDARD GENESIS (Do not touch - this creates the stable block)
  std::string const GENESIS_TX = "013c01ff0001ffffffffffff03029b2e4c0281c0b02e7c53291a94d1d0cb1e4352500868809f8fb98a13934343bf00021c7229b0f805f426284145a5568f9a23995873587e937d532f507119c6c483236c";
...
namespace config
{
  namespace testnet
  {
    ...
    boost::uuids::uuid const NETWORK_ID = { {
        0x12, 0x30, 0xF1, 0x71, 0x61, 0x04, 0x41, 0x61, 0x17, 0x31, 0x00, 0x82, 0x16, 0xA1, 0xA1, 0x89
      } };
